...
export const mockVesselGPSModules: VesselGPSModule[] = [
  // Container Ships
  {
    ...
    history: generateGPSTimeSeries('2024-01-24T00:00:00', 24, 3.0000, 101.4000, 0.001, 'docked'),
  },
  {
    id: 'vessel-002',
    ...
    history: generateGPSTimeSeries('2024-01-24T00:00:00', 24, 2.5000, 102.2000, 0.01, 'moving'),
  },
  {
    id: 'vessel-003',
    ...
    history: generateGPSTimeSeries('2024-01-24T00:00:00', 24, 2.9500, 101.3500, 0.0001, 'anchored'),
  },
  ...
  // Bulk Carriers
  {
    ...
    history: generateGPSTimeSeries('2024-01-24T00:00:00', 24, 3.0200, 101.4200, 0.001, 'docked'),
  },
  {
    id: 'vessel-005',
    ...
    history: generateGPSTimeSeries('2024-01-24T00:00:00', 24, 2.8000, 101.8000, 0.01, 'moving'),
  },
  ...
  // Tankers
  {
    ...
    history: generateGPSTimeSeries('2024-01-24T00:00:00', 24, 3.0400, 101.4400, 0.001, 'docked'),
  },
  {
    id: 'vessel-007',
    ...
    history: generateGPSTimeSeries('2024-01-24T00:00:00', 24, 2.9300, 101.3300, 0.0001, 'anchored'),
  },
  ...
  // Passenger Ships
  {
    ...
    history: generateGPSTimeSeries('2024-01-24T00:00:00', 24, 3.0600, 101.4600, 0.001, 'docked'),
  },
  ...
  // Fishing Vessels
  {
    ...
    history: generateGPSTimeSeries('2024-01-24T00:00:00', 24, 2.7000, 101.6000, 0.01, 'moving'),
  },
  {
    id: 'vessel-010',
    ...
    history: generateGPSTimeSeries('2024-01-24T00:00:00', 24, 3.0800, 101.4800, 0.001, 'docked'),
  },
  ...
  // Tugboats
  {
    ...
    history: generateGPSTimeSeries('2024-01-24T00:00:00', 24, 3.0100, 101.4100, 0.01, 'moving'),
  },
  {
    id: 'vessel-012',
