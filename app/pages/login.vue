  ...
  <div class="min-h-screen w-full flex">
    ...
    <div class="hidden md:flex w-1/2 h-screen bg-tenang-green flex-col items-center justify-center p-0 m-0">
      <div class="flex flex-col items-center justify-center w-full h-full px-16">
        <img src="~/assets/logo.png" alt="Tenang Site Logo" class="mb-12 mt-8 max-w-[320px] w-2/3 h-auto mx-auto" />
        <div class="w-48 border-t-4 mb-8 self-start" style="border-color: #84e4a8;"></div>
        <div class="mt-6 w-full">
          <h1 class="text-5xl font-bold mb-4 text-left w-full" style="color: #84e4a8;">Tenang Site</h1>
    ...
    <div class="flex flex-col justify-center items-center w-full md:w-1/2 h-screen bg-login-form">
      <div class="w-full px-12 max-w-lg">
        ...
        <p class="mb-8 text-gray-300">Enter your credentials to continue</p>
        <form @submit.prevent="handleLogin" class="space-y-6">
          ...
          <button type="submit" class="w-full py-3 px-4 bg-tenang-accent hover:bg-[#6fd19a] text-[#136355] font-bold rounded-lg shadow-lg transition-all duration-150 text-lg mt-2">Login</button>
        </form>
        <div class="mt-6 text-center text-sm text-gray-400">
          Don't have an account?
          <NuxtLink to="/register" class="text-tenang-accent hover:underline">Register</NuxtLink>
        </div>
      </div>
    </div>
  </div>
