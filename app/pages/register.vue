  ...
  <div class="min-h-screen w-full flex">
    ...
    <div class="flex flex-col justify-center items-center w-full md:w-1/2 h-screen bg-login-form">
      <div class="w-full px-12 max-w-lg">
        ...
        <p class="mb-8 text-gray-300">Sign up to get started</p>
        <form @submit.prevent="handleRegister" class="space-y-6">
          ...
          <button type="submit" class="w-full py-3 px-4 bg-tenang-accent hover:bg-[#6fd19a] text-[#136355] font-bold rounded-lg shadow-lg transition-all duration-150 text-lg mt-2">Register</button>
        </form>
        <div class="mt-6 text-center text-sm text-gray-400">
          Already have an account?
          <NuxtLink to="/login" class="text-tenang-accent hover:underline">Login</NuxtLink>
        </div>
      </div>
    </div>
  </div>
